...
import { percentages, tallyChoice, tallyScale, tallyCloud, tallyWritten, tallyRank, cloudWeight, answerKey, answerPoints, RIGHT_POINTS, SPEED_POINTS } from '../public/js/shared/aggregate.js?v=3';
