...
import { sanitiseText, cloudKey } from '../public/js/shared/sanitize.js?v=4';
import { normaliseCode } from '../public/js/shared/codes.js?v=4';
import { parseDeckFile } from '../public/js/decks.js?v=4';
...
test('el() refuses to be handed markup at all', async () => {
  const { el } = await import('../public/js/ui.js?v=4');
