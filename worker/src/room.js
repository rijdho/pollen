...
import { sanitiseText, wordCount, cloudKey } from '../../public/js/shared/sanitize.js?v=4';
import { tallyChoice, tallyScale, tallyCloud, tallyRank, tallyWritten, percentages, answerKey, answerPoints, RIGHT_POINTS, SPEED_POINTS } from '../../public/js/shared/aggregate.js?v=4';
import { readImage } from '../../public/js/shared/image.js?v=4';
